...
<html lang="en">
  <head>
    ...
    <title>Naufal Rafiawan Basara - @yield('title')</title>
  ...
  <body>
    {{-- offcanvas --}}
    <nav class="navbar navbar-dark bg-success sticky-top mb-3">
        <div class="container-fluid">
          ...
          <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            ...
            <div class="offcanvas-header text-light bg-success">
              <h5 class="offcanvas-title" id="offcanvasNavbarLabel">Naufal Rafiawan Basara</h5>
              <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
            </div>

            {{-- body --}}
            <div class="offcanvas-body bg-dark">
                <img src="layout-assets/img/3x4.jpg" class=" mx-auto d-block" alt="..." height="200px" width="200px" style="border-radius: 50%">
                ...
                <li class="nav-item">
                  <a href="/pegawai" class="nav-link text-light">
                ...
                <li class="nav-item">
                    <a href="/karyawan1" class="nav-link text-light">
                ...
                <li class="nav-item">
                  <a href="/pendapatan" class="nav-link text-light">
                ...
                <li class="nav-item">
                    <a href="/merkkertashvs" class="nav-link text-light">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="offcanvasNavbarDropdown">
                      <li><a class="dropdown-item" href="praktikumBootstrap">
                      ...
                      <li><a class="dropdown-item" href="praktikumJS">
                      ...
                      <li>
                          <a class="dropdown-item" href="/merkkertashvs">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-text" viewBox="0 0 16 16">
                                <path d="M5.5 7a.5.5 0 0 0 0 1h5a.5.5 0 0 0 0-1h-5zM5 9.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5zm0 2a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5z"/>
                                <path d="M9.5 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.5L9.5 0zm0 1v2A1.5 1.5 0 0 0 11 4.5h2V14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h5.5z"/>
                              </svg>
      ...
      <main style="min-height: 80vh" class="container">
        @section('content')
        @show
      </main>
    ...
    {{-- footer --}}
    <footer class="container-fluid bg-success text-light mt-5 sticky-bottom">
        <div class="row">
            <div class="container mt-3 d-flex justify-content-center">
                <a href="https://www.instagram.com/naufalrafiawan/" class="text-decoration-none text-light me-3" target="_blank">
                ...
                <a href="https://www.linkedin.com/in/naufalrafiawan/" class="text-decoration-none text-light me-3" target="_blank">
                ...
                <a href="https://github.com/naufalbasara" class="text-decoration-none text-light" target="_blank">
        ...
        <div class="row mt-3 text-center">
            <p>Made with <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-heart-fill" viewBox="0 0 16 16">
              ...
              </svg> by Naufal Basara</p>
              <p>Pemrograman Web D - 5026201117</p>
        </div>
      </footer>
